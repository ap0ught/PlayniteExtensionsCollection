# Steam Store Screenshots Viewer - Development Guide

This document contains development-specific information for the Steam Store Screenshots Viewer extension.
...
```bash
cd source/SteamScreenshots/SteamScreenshots
```
