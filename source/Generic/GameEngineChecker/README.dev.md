# Game Engine Checker - Development Guide

This document contains development-specific information for the Game Engine Checker extension.
...
```bash
cd source/GameEngineChecker/GameEngineChecker
```
