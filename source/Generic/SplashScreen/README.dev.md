# Splash Screen - Development Guide

This document contains development-specific information for the Splash Screen extension.
...
```bash
cd source/SplashScreen/SplashScreen
```
