# Steam Game Importer - Development Guide

This document contains development-specific information for the Steam Game Importer extension.
...
```bash
cd source/SteamGameImporter/SteamGameImporter
```
