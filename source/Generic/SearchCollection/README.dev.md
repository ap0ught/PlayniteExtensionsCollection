# Search Collection - Development Guide

This document contains development-specific information for the Search Collection extension.
...
```bash
cd source/SearchCollection/SearchCollection
```
