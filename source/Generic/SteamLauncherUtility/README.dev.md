# Steam Launcher Utility - Development Guide

This document contains development-specific information for the Steam Launcher Utility extension.
...
```bash
cd source/SteamLauncherUtility/SteamLauncherUtility
```
