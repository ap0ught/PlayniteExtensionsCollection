# NVIDIA GE GameStream Export - Development Guide

This document contains development-specific information for the NVIDIA GE GameStream Export extension.
...
```bash
cd source/NVIDIAGEGameStreamExport/NVIDIAGEGameStreamExport
```
