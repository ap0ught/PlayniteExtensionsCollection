# Extra Metadata Loader - Development Guide

This document contains development-specific information for the Extra Metadata Loader extension.
...
```bash
cd source/ExtraMetadataLoader/ExtraMetadataLoader
```
