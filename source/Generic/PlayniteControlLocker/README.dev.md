# Playnite Control Locker - Development Guide

This document contains development-specific information for the Playnite Control Locker extension.
...
```bash
cd source/PlayniteControlLocker/PlayniteControlLocker
```
