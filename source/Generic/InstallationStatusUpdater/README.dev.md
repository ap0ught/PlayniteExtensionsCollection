# Installation Status Updater - Development Guide

This document contains development-specific information for the Installation Status Updater extension.
...
```bash
cd source/InstallationStatusUpdater/InstallationStatusUpdater
```
