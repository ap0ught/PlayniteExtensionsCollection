# Cooperative Modes Importer - Development Guide

This document contains development-specific information for the Cooperative Modes Importer extension.
...
```bash
cd source/CooperativeModesImporter/CooperativeModesImporter
```
