# GOG Second Class Game Watcher - Development Guide

This document contains development-specific information for the GOG Second Class Game Watcher extension.
...
```bash
cd source/GOGSecondClassGameWatcher/GOGSecondClassGameWatcher
```
