# Steam Game Transfer Utility - Development Guide

This document contains development-specific information for the Steam Game Transfer Utility extension.
...
```bash
cd source/SteamGameTransferUtility/SteamGameTransferUtility
```
