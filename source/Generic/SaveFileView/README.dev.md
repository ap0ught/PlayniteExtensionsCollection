# Save File View - Development Guide

This document contains development-specific information for the Save File View extension.
...
```bash
cd source/SaveFileView/SaveFileView
```
