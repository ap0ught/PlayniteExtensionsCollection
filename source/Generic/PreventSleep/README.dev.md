# Prevent Sleep - Development Guide

This document contains development-specific information for the Prevent Sleep extension.
...
```bash
cd source/PreventSleep/PreventSleep
```
