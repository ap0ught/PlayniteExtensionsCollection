# Nexus Mods checker - Development Guide

This document contains development-specific information for the Nexus Mods checker extension.
...
```bash
cd source/NexusModsChecker/NexusModsChecker
```
