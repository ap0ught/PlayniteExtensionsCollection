# Steam Shortcuts - Development Guide

This document contains development-specific information for the Steam Shortcuts extension.
...
```bash
cd source/SteamViewer/SteamViewer
```
