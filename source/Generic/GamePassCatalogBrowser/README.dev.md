# Game Pass Catalog Browser - Development Guide

This document contains development-specific information for the Game Pass Catalog Browser extension.
...
```bash
cd source/GamePassCatalogBrowser/GamePassCatalogBrowser
```
