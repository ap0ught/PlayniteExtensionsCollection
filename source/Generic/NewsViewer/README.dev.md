# Steam News and Players Viewer - Development Guide

This document contains development-specific information for the Steam News and Players Viewer extension.
...
```bash
cd source/NewsViewer/NewsViewer
```
