# Filter Presets Quick Launcher - Development Guide

This document contains development-specific information for the Filter Presets Quick Launcher extension.
...
```bash
cd source/FilterPresetsQuickLauncher/FilterPresetsQuickLauncher
```
