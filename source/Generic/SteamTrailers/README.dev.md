# Steam Trailers - Development Guide

This document contains development-specific information for the Steam Trailers extension.
...
```bash
cd source/SteamTrailers/SteamTrailers
```
