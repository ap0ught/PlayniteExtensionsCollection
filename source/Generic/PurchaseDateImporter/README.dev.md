# Purchase Date Importer - Development Guide

This document contains development-specific information for the Purchase Date Importer extension.
...
```bash
cd source/PurchaseDateImporter/PurchaseDateImporter
```
