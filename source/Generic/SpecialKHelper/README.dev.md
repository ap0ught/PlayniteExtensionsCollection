# Special K Helper - Development Guide

This document contains development-specific information for the Special K Helper extension.
...
```bash
cd source/SpecialKHelper/SpecialKHelper
```
