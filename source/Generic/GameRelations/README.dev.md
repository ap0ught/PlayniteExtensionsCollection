# Game Relations - Development Guide

This document contains development-specific information for the Game Relations extension.
...
```bash
cd source/GameRelations/GameRelations
```
