# Covers Collage Maker - Development Guide

This document contains development-specific information for the Covers Collage Maker extension.
...
```bash
cd source/CoverCollageMaker/CoverCollageMaker
```
