# Twitch link importer - Development Guide

This document contains development-specific information for the Twitch link importer extension.
...
```bash
cd source/TwitchAddLink/TwitchAddLink
```
