# Steam Game Status Detector - Development Guide

This document contains development-specific information for the Steam Game Status Detector extension.
...
```bash
cd source/SteamGameStatusDetector/SteamGameStatusDetector
```
