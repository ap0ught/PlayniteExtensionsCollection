# Game Media Tools - Development Guide

This document contains development-specific information for the Game Media Tools extension.
...
```bash
cd source/GameMediaTools/GameMediaTools
```
