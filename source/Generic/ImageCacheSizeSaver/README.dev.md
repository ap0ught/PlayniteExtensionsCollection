# Image Cache Size Saver - Development Guide

This document contains development-specific information for the Image Cache Size Saver extension.
...
```bash
cd source/ImageCacheSizeSaver/ImageCacheSizeSaver
```
