# Details to Grid View Converter - Development Guide

This document contains development-specific information for the Details to Grid View Converter extension.
...
```bash
cd source/ThemesDetailsViewToGridViewConverter/ThemesDetailsViewToGridViewConverter
```
