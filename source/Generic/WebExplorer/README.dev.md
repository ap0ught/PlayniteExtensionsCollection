# Web Explorer - Development Guide

This document contains development-specific information for the Web Explorer extension.
...
```bash
cd source/Generic/WebExplorer/WebExplorer
```
