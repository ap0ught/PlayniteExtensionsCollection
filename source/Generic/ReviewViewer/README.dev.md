# Steam Reviews Viewer - Development Guide

This document contains development-specific information for the Steam Reviews Viewer extension.
...
```bash
cd source/ReviewViewer/ReviewViewer
```
