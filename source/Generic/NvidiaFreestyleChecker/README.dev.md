# NVIDIA Freestyle checker - Development Guide

This document contains development-specific information for the NVIDIA Freestyle checker extension.
...
```bash
cd source/NvidiaFreestyleChecker/NvidiaFreestyleChecker
```
