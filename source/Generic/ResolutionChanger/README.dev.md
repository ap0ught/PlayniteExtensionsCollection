# Display Helper - Development Guide

This document contains development-specific information for the Display Helper extension.
...
```bash
cd source/ResolutionChanger/ResolutionChanger
```
