# Steam Wishlist Discount Notifier - Development Guide

This document contains development-specific information for the Steam Wishlist Discount Notifier extension.
...
```bash
cd source/SteamWishlistDiscountNotifier/SteamWishlistDiscountNotifier
```
