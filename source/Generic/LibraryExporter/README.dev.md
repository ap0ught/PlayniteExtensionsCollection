# Library Exporter Advanced - Development Guide

This document contains development-specific information for the Library Exporter Advanced extension.
...
```bash
cd source/LibraryExporter/LibraryExporter
```
