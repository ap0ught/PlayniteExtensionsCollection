# OpenCritic Metadata - Development Guide

This document contains development-specific information for the OpenCritic Metadata extension.
...
```bash
cd source/Metadata/OpenCriticMetadata/OpenCriticMetadata
```
