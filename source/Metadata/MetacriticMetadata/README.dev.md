# Metacritic Metadata - Development Guide

This document contains development-specific information for the Metacritic Metadata extension.
...
```bash
cd source/Metadata/MetacriticMetadata/MetacriticMetadata
```
