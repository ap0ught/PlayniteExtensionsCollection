# VNDB Nexus - Development Guide

This document contains development-specific information for the VNDB Nexus extension.
...
```bash
cd source/Metadata/VNDBNexus/VNDBNexus
```
