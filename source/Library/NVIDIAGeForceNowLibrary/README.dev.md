# NVIDIA GeForce NOW Library - Development Guide

This document contains development-specific information for the NVIDIA GeForce NOW Library extension.
...
```bash
cd source/Library/NVIDIAGeForceNowLibrary/NVIDIAGeForceNowLibrary
```
