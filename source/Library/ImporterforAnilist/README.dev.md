# Importer for Anilist - Development Guide

This document contains development-specific information for the Importer for Anilist extension.
...
```bash
cd source/Library/ImporterforAnilist/ImporterforAnilist
```
